...
function Open-TeamRest {
    ...
    Wait-Agent $script:TransitionBufferMs
    Click-GameRelative $Handle 0.976 0.736 'MC 1 plus - test'
    Wait-Agent $script:TransitionBufferMs

    $form.TopMost = $true
    Add-Log 'Otvoren je Fizio centar za MC 1 (test od prvog MC-a).'
}
...
function Run-TeamRestManualQueue {
    ...
    # MC 1 plus je vec otvoren u Open-TeamRest.
    Wait-ManualTeamRestAd $Handle 'MC 1'
